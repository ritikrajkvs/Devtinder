const Footer = () => {
  return (
    <footer className="footer footer-center p-10 bg-gray-900/80 backdrop-blur-md text-gray-400 border-t border-gray-800 mt-10">
      <aside>
        <div className="flex items-center gap-2 mb-2">
            <span className="text-3xl">🔥</span>
            <span className="text-2xl font-bold text-gray-200">DevTinder</span>
        </div>
        <p className="font-medium">
          Connecting Developers to Collaborate & Build.
          <br />
      ...
      <nav>
        <div className="grid grid-flow-col gap-6">
          <a
            href="https://x.com/RitikRa67188018"
            target="_blank"
